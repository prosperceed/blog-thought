...
return <h1>Error loading articles</h1>
  ...
  return (
    ...
    <svg aria-hidden="true" className="inline w-10 h-10 text-gray-200 animate-spin dark:text-blue-500 fill-blue-700" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
